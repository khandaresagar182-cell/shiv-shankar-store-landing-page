...
const reviews = [
  {
    name: 'Anil Waghmare',
    text: 'Good curtain and blinds. The quality and finishing is absolutely top-notch. Mauli Furnishing team helped us pick the perfect design for our living room. Highly recommended!',
    rating: 5,
  },
  {
    name: 'Ekta Yadav',
    text: 'Good collection of home furnishing. They have an amazing variety of products — from mattresses to curtains, everything under one roof. Staff is very helpful and knowledgeable.',
    rating: 4,
  },
  {
    name: 'Bhanudas N',
    text: 'Best place for mattresses and home furnishing in Dhanori! Very satisfied with the product quality and reasonable pricing. Will definitely visit again for more purchases.',
    rating: 5,
  },
];
              ...
              <div className="flex items-center gap-3 pt-4 border-t border-maroon-100/50">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-1.5">
                    ...
                    <span className="text-maroon-900/40 text-xs font-inter">Google Review</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="text-center">
          <div className="inline-flex flex-col items-center bg-gradient-to-br from-maroon-800 to-maroon-900 rounded-3xl p-10 sm:p-14 shadow-2xl shadow-maroon-900/20 max-w-2xl">
            ...
            <a
              ...
              className="group flex items-center gap-2 sm:gap-3 bg-gradient-to-r from-gold-500 to-gold-600 text-maroon-950 px-6 sm:px-8 py-3 sm:py-4 rounded-full font-bold text-sm sm:text-base hover:from-gold-400 hover:to-gold-500 transition-all duration-300 shadow-xl shadow-gold-500/20 hover:shadow-gold-500/40 hover:-translate-y-1 pulse-glow"
            >
