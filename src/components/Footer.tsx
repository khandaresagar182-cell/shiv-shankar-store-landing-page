      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-12">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex gap-3">
              {['Facebook', 'Instagram', 'WhatsApp'].map((social) => (
                <a
                  key={social}
                  href={social === 'WhatsApp' ? 'https://wa.me/c/917498093633' : '#'}
            ...
            <div className="space-y-4">
              <a href="tel:+917498093633" className="flex items-start gap-3 group">
                ...
                <div>
                  ...
                  <p className="text-white/30 font-inter text-xs">Mon-Sat, 9AM-8PM</p>
                </div>
              </a>
              ...
              <a href="mailto:akshayshete2170@gmail.com" className="flex items-start gap-3 group">
                ...
                <div>
                  <p className="text-white/70 font-inter text-sm">akshayshete2170@gmail.com</p>
              ...
              <a href="https://maps.app.goo.gl/bY697UhbHq58mx9PA?g_st=aw" target="_blank" rel="noopener noreferrer" className="flex items-start gap-3 group">
                ...
                <div>
                  <p className="text-white/70 font-inter text-sm">Mauli Krupa Apartment, Kuwarbav, Ratnagiri, MH 415639</p>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-white/30 font-inter text-xs">Mon - Sat: 9 AM - 8 PM (Sunday Closed)</p>
                </div>
              </div>
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2 text-white/30 font-inter text-sm">
            Made with <Heart size={14} className="text-red-500" fill="currentColor" /> in India
          </div>
        </div>
      </div>
